...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/enquery-form", element: <EnqueryForm /> },
      { path: "/automation", element: <Automation /> },
      { path: "/products/automation-industrial-engineering", element: <AutomationPage /> },
      { path: "/products/emc-emi-testing", element: <EMCPage /> },
      { path: "/products/test-measuring", element: <TestMeasurePage /> },
    ],
  },
]);
